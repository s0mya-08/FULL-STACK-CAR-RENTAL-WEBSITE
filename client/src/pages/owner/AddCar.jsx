        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <div className='flex flex-col w-full'>
                    <label>Brand</label>
                    <input type="text" name="" id="" placeholder='e.g. BMW, Mercedes, Audi...' required
                ...
                <div className='flex flex-col w-full'>
                    <label>Model</label>
                    <input type="text" name="" id="" placeholder='e.g. X5 E-Class, M4...' required
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                    <div className='flex flex-col w-full'>
                        <label>Year</label>
                        <input type="number" name="" id="" placeholder="2025" required
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <input type="number" name="" id="" placeholder={`${currency}10,000`} required
            ...
            {/* Car Transmission, Fuel Type and Cap. */}
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                <div className='flex flex-col w-full'>
